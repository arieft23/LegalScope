...
<head>
	...
	<!-- Document Title
		============================================= -->
		<title>LegalScoope Indonesia</title>
		...
		<div id="side-panel" class="dark">
			...
			<div class="side-panel-wrap">
				...
				<div class="widget widget_links clearfix">
					...
					<h4>LegalScope Indonesia</h4>

					<div style="font-size: 14px; line-height: 1.7;">
						<address style="line-height: 1.7;">
							Jl. Kebon Kacang 22/79<br>
							Jakarat Pusat <br>
						</address>

						<div class="clear topmargin-sm"></div>

						<abbr title="Phone Number">Phone:</abbr> (+62)81294635259<br>
						<abbr title="Email Address">Email for Info:</abbr> nova@legalscope.com
					</div>
			...
			<header id="header" class="full-header transparent-header border-full-header dark static-sticky" data-sticky-class="not-dark" data-sticky-offset="full" data-sticky-offset-negative="100">
				...
				<div id="header-wrap">
					...
					<!-- Logo
						============================================= -->
						<div id="logo">
							<a href="index.html" class="standard-logo">LegalScope</a>
							<a href="index.html" class="retina-logo">LegalScope</a>
						</div><!-- #logo end -->
		...
		<!-- Slider
			...
			<section id="slider" class="slider-parallax full-screen force-full-screen">
				...
				<div class="slider-parallax-inner">
					...
					<div class="full-screen force-full-screen dark section nopadding nomargin noborder ohidden" style="background-image: url('one-page/images/page/gedung.jpg'); background-size: cover; background-position: center center;">
				...
				<div class="content-wrap nopadding">
						...
						<div class="container clearfix">
							...
							<div class="row topmargin-lg divcenter" style="max-width: 1000px;">
								...
								<div class="col-sm-4 bottommargin">
									...
									<div class="team">
										<div class="team-image">
											<img src="one-page/images/foto ceo2.jpg" alt="John Doe">
								...
								<div class="col-sm-4 bottommargin">
									...
									<div class="team">
										<div class="team-image">
											<img src="one-page/images/foto ceo2.jpg" alt="Josh Clark">
											<div class="team-overlay">
												<div class="team-social-icons">
													<a href="#" class="social-icon si-borderless si-small si-twitter" title="Twitter">
														<i class="icon-twitter"></i>
								...
								<div class="col-sm-4 bottommargin">
									...
									<div class="team">
										<div class="team-image">
											<img src="one-page/images/foto ceo2.jpg" alt="Mary Jane">
											<div class="team-overlay">
												<div class="team-social-icons">
													<a href="#" class="social-icon si-borderless si-small si-twitter" title="Twitter">
														<i class="icon-twitter"></i>
						...
						<div class="section nomargin">
							<div class="container clearfix">
								<div class="divcenter center" style="max-width: 900px;">
									<h2 class="nobottommargin t300 ls1">Kami bekerja dengan cepat dan tepat untuk anda dalam segala aspek yang kami kerjakan, pekerja handal dan sistem yang terintegerasi modern akan memudahkan semua urusan yang anda serahkan.</h2>
								</div>
							</div>
						</div>
						...
						<div id="portfolio" class="portfolio grid-container portfolio-nomargin portfolio-full portfolio-masonry mixed-masonry clearfix">
							...
							<article class="portfolio-item pf-media pf-icons wide">
								<div class="portfolio-image">
									<a href="#">
										<img src="one-page/images/computer3.jpg" alt="Open Imagination">
									</a>
									<div class="portfolio-overlay">
										<div class="portfolio-desc">
											<h3><a href="#">Wawasan Luas</a></h3>
							...
							<article class="portfolio-item pf-illustrations">
								<div class="portfolio-image">
									<a href="#">
										<img src="one-page/images/computer2.jpg" alt="Locked Steel Gate">
									</a>
									<div class="portfolio-overlay">
										<div class="portfolio-desc">
											<h3><a href="#">Proses Mudah</a></h3>
							...
							<article class="portfolio-item pf-graphics pf-uielements">
								<div class="portfolio-image">
									<a href="#">
										<img src="one-page/images/computer1.jpg" alt="Mac Sunglasses">
									</a>
									<div class="portfolio-overlay">
										<div class="portfolio-desc">
											<h3><a href="#">Sistem Modern</a></h3>
							...
							<article class="portfolio-item pf-media pf-icons wide">
								<div class="portfolio-image">
									<a href="#">
										<img src="one-page/images/bisnismen2.jpg" alt="Open Imagination">
									</a>
									<div class="portfolio-overlay">
										<div class="portfolio-desc">
											<h3><a href="#">Bekerja Tepat</a></h3>
							...
							<article class="portfolio-item pf-uielements pf-media wide">
								<div class="portfolio-image">
									<a href="#">
										<img src="one-page/images/bisnismen1.jpg" alt="Console Activity">
									</a>
									<div class="portfolio-overlay">
										<div class="portfolio-desc">
											<h3><a href="#">Bekerja Cepat</a></h3>
					...
					<div id="section-services" class="page-section notoppadding">
						...
						<div class="section nomargin">
							<div class="container clearfix">
								<div class="divcenter center" style="max-width: 900px;">
									<h2 class="nobottommargin t300 ls1">Kami menikmati setiap pekerjaan yang kami kerjakan, maka dari itu jangan ragu untuk percaya pada service yang telah kami sediakan.</h2>
								</div>
							</div>
						</div>
						...
						<div class="section dark nomargin">
							<div class="divcenter center" style="max-width: 900px;">
								<h2 class="nobottommargin t300 ls1"> Tertarik? Ayo <a href="#" data-scrollto="#template-contactform" data-offset="140" data-easing="easeInOutExpo" data-speed="1250" class="button button-border button-circle button-light button-large notopmargin nobottommargin" style="position: relative; top: -3px;">Coba Sekarang</a></h2>
							</div>
						</div>
...
<div class="py-5 bg-dark text-white">
	<div class="container">
		<div class="row">
			<div class="col-md-6 text-center align-self-center">
				<p class="mb-5"> <br><br><br><br> <strong>LegalScope Indonesia.</strong><br>
					<br>
					<br>Jl. Kebon Kacang 22/79
					<br>Jakarta Pusat
					<br> <abbr title="Phone">Phone:</abbr> (+62)81294635259 </p>
					<div class="my-3 row">
						<div class="col-4">
	...
	<div id="copyrights">
		...
		<div class="container center clearfix">
			Copyright Legalscope Indonesia 2017 | All Rights Reserved
		</div>
	</div>
